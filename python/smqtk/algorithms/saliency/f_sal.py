...
class Fast_SaliencyBlackbox (SaliencyBlackbox):
    ...
    def from_iqr_session(cls, iqrs, descr_gen, base_image): 
        ...
        return Fast_SaliencyBlackbox(ADJs, rel_index, descr_gen, base_image)
...
class Fast_ImageSaliencyAugmenter(ImageSaliencyAugmenter):
    """
    ...
    def augment_roughpass(self, image_mat):
...
SALIENCY_BLACKBOX_CLASS = Fast_SaliencyBlackbox
IMG_SALIENCY_AUGMENTER_CLASS = Fast_ImageSaliencyAugmenter
